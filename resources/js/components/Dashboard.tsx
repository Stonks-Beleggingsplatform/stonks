                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-baseline gap-4">
                            <h1 className="text-5xl font-black tracking-tighter">
                                ${(portfolio?.total_value || user?.balance || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                            </h1>
                        ...
                        <div className="mt-6 flex gap-8">
                            <div>
                                ...
                                <p className="text-lg font-bold">${(user?.balance || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Invested</p>
                                <p className="text-lg font-bold">${((portfolio?.total_value || 0) - (user?.balance || 0)).toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                            </div>
                        </div>
                    </div>
                </section>
